        ...
        <form onSubmit={methods.handleSubmit(onFormSubmit)}>
          <div className={styles.FieldDiv}>
            <div className={styles.LeftDiv}>
              ...
              />
              { methods.errors.city && <span className={styles.Error}>Select Your City</span> }
            </div>
            <div className={styles.RightDiv}>
              <Input name="last_name" type="text" labelInputId="LastName" label="Last Name" />
              ...
              />
              { methods.errors.country && <span className={styles.Error}>Select Your Country</span> }
              <SelectDropDown
                name="role"
                defaultValue='- Role -'
