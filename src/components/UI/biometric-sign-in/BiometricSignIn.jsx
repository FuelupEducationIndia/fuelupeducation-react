...
const BiometricSignIn = ({ closeModal, displayModal, bioSignInInfo }) => {
  ...
  return (
    <div className={styles.modal} onClick={closeTheModal} style={divStyle}>
      <div
        className={styles.ModalContentDiv}
        onClick={e => e.stopPropagation()}>
        <div className={styles.ModalHeading}>
          <div className={styles.ModalHeadingText}>Sign In</div>
          <div className={styles.close} onClick={closeTheModal}>
            &times;{' '}
          </div>
        </div>
        <div className={styles.ModalContentHeading}>
          ...
          <div className={styles.FairlyStatic}>
            ...
            <span className={styles.Purple}>
              Fuelup Education can verify it's you
            </span>
          </div>
          <div className={styles.SignInImage}>
            {!success ? (
              <img
                style={bioSignInInfo.styles}
                src={bioSignInInfo.image}
                alt=""
              />
            ) : (
              <div className={styles.SuccessDiv}>
                <img className={styles.CheckMarkIcon} src={checkmark} alt="" />
          ...
          <span className={success ? styles.Hide : styles.Sensor}>
            {bioSignInInfo.imageText}
          </span>
          {!bioSignInInfo.hide && (
            <div className={success ? styles.Hide : styles.CancelOrSignIn}>
              <span onClick={closeTheModal} id={styles.Cancel}>
                Cancel
              </span>
              <button
                onClick={handleClick}
